...
url_descuento <- "https://geoportalgasolineras.es/downloadReportPlanes?extension=CSV"
...
dfdescuento <- read.csv(url_descuento)
...
write_csv(df1,"datos_19-01.csv")
datos19<-read_csv("datos_19-01.csv")

dia<- datos19  %>% mutate('dia' = '19-01') %>% view()